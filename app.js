...
function greet(){var h=new Date().getHours();var g=h<12?'Good morning':h<17?'Good afternoon':'Good evening';addMsg('bot',g+'! I&#39;m the Tre for <b>Mattress by Appointment Sumter</b>.<br><br>Quick question &#8212; what&#39;s going on with your current sleep situation?');setQuick([{label:'My mattress is old / worn out',value:'old_mattress'},{label:'Back or body pain',value:'pain'},{label:'Sleeping hot / not comfortable',value:'hot'},{label:'Looking for an upgrade',value:'upgrade'},{label:'Just checking prices',value:'price'}]);state.step='discovery';save();}
function route(v){
...
function answerBrands(){addMsg('bot','We carry <b>Serta, Sealy, Simmons, Southerland, Malouf,</b> and <b>Allswell</b> &#8212; exact same brands you would see at retail, at 50-80% below their prices.<br><br>Small operation, low overhead. That savings goes directly to you.<br><br>Want to come see the lineup?');setQuick([{label:'Today',value:'today'},{label:'This weekend',value:'this_weekend'},{label:'What are the prices?',value:'price'}]);state.step='closing';save();}
