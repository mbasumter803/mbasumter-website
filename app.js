...
function route(v){
  ...
  if(v==='today'||v==='tomorrow'||/^(monday|tuesday|wednesday|thursday|friday|saturday|sunday)$/.test(v)){state.day=cap(v);save();return askTime();}
